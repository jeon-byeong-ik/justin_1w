...
## ▶ 바로 플레이 (패드·폰·PC, 설치 불필요)
- **웹 버전:** [`web/index.html`](web/index.html) — 브라우저에서 터치로 바로 실행. 실행법은 [`web/README.md`](web/README.md).
- **Godot 버전:** [`game/`](game/) — Godot 4.3+ 에디터에서 열어 실행/모바일 내보내기. (두 버전은 동일 게임)
